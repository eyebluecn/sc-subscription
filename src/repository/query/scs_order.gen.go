...
func newOrderDO(db *gorm.DB, opts ...gen.DOOption) orderDO {
	...
	_orderDO.orderDODo.UseModel(&db_model.OrderDO{})
...
func (o orderDODo) Create(values ...*db_model.OrderDO) error {
	if len(values) == 0 {
		return nil
	}
...
func (o orderDODo) CreateInBatches(values []*db_model.OrderDO, batchSize int) error {
	return o.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (o orderDODo) Save(values ...*db_model.OrderDO) error {
	if len(values) == 0 {
		return nil
	}
...
func (o orderDODo) First() (*db_model.OrderDO, error) {
	if result, err := o.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*db_model.OrderDO), nil
	}
}

func (o orderDODo) Take() (*db_model.OrderDO, error) {
...
func (o orderDODo) Last() (*db_model.OrderDO, error) {
...
func (o orderDODo) Find() ([]*db_model.OrderDO, error) {
	result, err := o.DO.Find()
	return result.([]*db_model.OrderDO), err
}

func (o orderDODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_model.OrderDO, err error) {
	buf := make([]*db_model.OrderDO, 0, batchSize)
...
func (o orderDODo) FindInBatches(result *[]*db_model.OrderDO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (o orderDODo) FirstOrInit() (*db_model.OrderDO, error) {
...
func (o orderDODo) FirstOrCreate() (*db_model.OrderDO, error) {
...
func (o orderDODo) FindByPage(offset int, limit int) (result []*db_model.OrderDO, count int64, err error) {
...
func (o orderDODo) Delete(models ...*db_model.OrderDO) (result gen.ResultInfo, err error) {
