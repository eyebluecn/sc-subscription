...
func newSubscriptionDO(db *gorm.DB, opts ...gen.DOOption) subscriptionDO {
	...
	_subscriptionDO.subscriptionDODo.UseModel(&db_model.SubscriptionDO{})
...
func (s subscriptionDODo) Create(values ...*db_model.SubscriptionDO) error {
	if len(values) == 0 {
		return nil
	}
...
func (s subscriptionDODo) CreateInBatches(values []*db_model.SubscriptionDO, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s subscriptionDODo) Save(values ...*db_model.SubscriptionDO) error {
	if len(values) == 0 {
		return nil
	}
...
func (s subscriptionDODo) First() (*db_model.SubscriptionDO, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*db_model.SubscriptionDO), nil
	}
}

func (s subscriptionDODo) Take() (*db_model.SubscriptionDO, error) {
...
func (s subscriptionDODo) Last() (*db_model.SubscriptionDO, error) {
...
func (s subscriptionDODo) Find() ([]*db_model.SubscriptionDO, error) {
	result, err := s.DO.Find()
	return result.([]*db_model.SubscriptionDO), err
}

func (s subscriptionDODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_model.SubscriptionDO, err error) {
	buf := make([]*db_model.SubscriptionDO, 0, batchSize)
...
func (s subscriptionDODo) FindInBatches(result *[]*db_model.SubscriptionDO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s subscriptionDODo) FirstOrInit() (*db_model.SubscriptionDO, error) {
...
func (s subscriptionDODo) FirstOrCreate() (*db_model.SubscriptionDO, error) {
...
func (s subscriptionDODo) FindByPage(offset int, limit int) (result []*db_model.SubscriptionDO, count int64, err error) {
...
func (s subscriptionDODo) Delete(models ...*db_model.SubscriptionDO) (result gen.ResultInfo, err error) {
